                        ...
                        <section>
                            <header>
                                ...
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    {{ __("Each task need have these information") }}
                                </p>
                            </header>
                            <div class="mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="start_time" name="start_time" type="date" class="mt-1 block w-full" :value="old('start_time')" autofocus autocomplete="start_time" />
                                <x-input-error class="mt-2" :messages="$errors->get('start_time')" />
                            </div>
                            <div class="mt-4">
                                <x-input-label for="end_time" :value="__('End time')" />
                                <x-text-input id="end_time" name="end_time" type="date" class="mt-1 block w-full" :value="old('end_time')" autofocus autocomplete="end_time" />
                                <x-input-error class="mt-2" :messages="$errors->get('end_time')" />
                            </div>
                            <div class="mt-8 flex flex-row items-center">
                                <x-input-label for="priority" :value="__('Priority')" />
                                <x-dropdown-search class="ml-4" placeholder="Select priority" inputName="priority" :options="$priorities" />
                            </div>
                            <div class="mt-8 flex flex-row items-center">
                                <x-input-label for="status" :value="__('Status')" />
                                <x-dropdown-search class="ml-4" placeholder="Select status" inputName="status" :options="$statuses" />
                            </div>
                            <div class="mt-8 flex flex-row items-center">
                                <x-input-label for="project" :value="__('Project')" />
                                <x-dropdown-search class="ml-4" placeholder="Select project" inputName="project" onSelect="getPersonsOfProject" :options="$projects" />
                            </div>
                        </section>
                    </div>
                    <div class="mt-10">
