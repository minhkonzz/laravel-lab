                                ...
                                <td class="px-6 py-4">
                                    <form action="{{ route('persons.destroy', $person->id) }}" method="POST">
                                        ...
                                        <a  x-data="{ showTooltip: false }"
                                            ...
                                            href="{{ route('persons.show', $person->id) }}" class="relative inline-block mt-2">
                                        ...
                                        <a  x-data="{ showTooltip: false }"
                                            @mouseenter="showTooltip = true"
                                            @mouseleave="showTooltip = false"
                                            href="{{ route('persons.edit', $person->id) }}" class="relative inline-block mb-1 mx-4">
                                        ...
                                        <button
                                            ...
                                            @mouseleave="showTooltip = false" 
                                            type="submit" 
                                            onclick="return confirm('Do you want to delete this person?');" 
                                            class="relative">
