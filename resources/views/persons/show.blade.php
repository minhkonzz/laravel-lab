        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        @foreach([
                            ['title' => 'Full name',    'value' => $person->full_name],
                            ['title' => 'Gender',       'value' => $person->gender],
                            ['title' => 'Birthdate',    'value' => $person->birthdate],
                            ['title' => 'Phone number', 'value' => $person->phone_number],
                            ['title' => 'Email',        'value' => $person->email],
                            ['title' => 'Address',      'value' => $person->address],
                            ['title' => 'Company',      'value' => $person->company->name]
                        ] as $attribute)
                            <div class="mt-8">
