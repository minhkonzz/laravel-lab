                                ...
                                <td class="px-6 py-4">
                                    <form action="{{ route('companies.destroy', $company->id) }}" method="POST">
                                        ...
                                        <a  x-data="{ showTooltip: false }"
                                            ...
                                            href="{{ route('companies.show', $company->id) }}" class="relative inline-block mt-2">
                                        ...
                                        <a  x-data="{ showTooltip: false }"
                                            @mouseenter="showTooltip = true"
                                            @mouseleave="showTooltip = false"
                                            href="{{ route('companies.edit', $company->id) }}" class="relative inline-block mb-1 mx-2">
                                        ...
                                        <button
                                            ...
                                            @mouseleave="showTooltip = false" 
                                            type="submit" 
                                            onclick="return confirm('Do you want to delete this company?');" 
                                            class="relative mb-8">
